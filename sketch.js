...
function setup(){
    ...
    player = new Player(30,330,50,50)
    ...
    fieldBoundarytop = Bodies.rectangle(600,0,1200,10,options)
    World.add(world,fieldBoundarytop)

    fieldBoundarybottom = Bodies.rectangle(600,400,1200,10,options)
    World.add(world,fieldBoundarybottom)
